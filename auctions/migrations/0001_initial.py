# Generated by Django 3.2.4 on 2021-07-27 09:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', max_length=32, null=True, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            name='Watchlist',
            fields=[
                ('listing', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='auctions.auction')),
